...
export default function WorkExperience() {
  return (
    <div className="mt-8 border-t-[1px] dark:border-neutral-500 border-neutral-400">
      <h1 className="my-4 text-2xl font-bold">Work Experience</h1>
      <ul className="border-l-[1px] dark:border-neutral-500 border-neutral-400 list-outside pl-2">
